// Refactor the code below by using variables to remove repetition.
let applesCost =10;
let mangoesCost= 20;
let bananasCost= 15;
let peachesCost=22;
...
console.log(`A dozen apple cost Rs. ${applesCost * 12}`);
console.log(`Six mangoes cost Rs. ${applesCost * 6}`)
